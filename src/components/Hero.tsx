  ...
  return (
    <>
      <section className='flex flex-col items-center z-10'>
        ...
        >
          <div className='max-w-xl flex flex-col items-center text-center pt-8 lg:pt-32 pb-16 lg:pb-48 my-20 lg:my-24'>
            <p className='text-white md:text-lg xl:text-xl font-semibold mb-4 md:mb-6'>
            ...
            <div className='w-full flex flex-col sm:flex-row sm:justify-center gap-2.5'>
              ...
              >
                <Button variant='blue'>Take a tour</Button>
              </motion.div>
            </div>
          </div>
        </motion.div>
        ...
        <div className='flex justify-center lg:justify-start items-center gap-4'>
          ...
          <div className='flex gap-4'>
            <a
              href='#'
              target='_blank'
              className='text-white hover:text-blue-50 active:text-blue-100 transition duration-100'
            >
              <svg
                className='w-5 h-5'
                width='24'
