export default function Footer() {
  return (
    <footer>
      <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16'>
        <div className='col-span-full lg:col-span-2'>
          <div className='lg:-mt-2 mb-4'>
            <a
              href='/'
              className='inline-flex items-center text-black-800 text-xl md:text-2xl font-bold gap-2 text-blue-900 uppercase'
              aria-label='logo'
            >
              <svg
                width='30'
          ...
          <p className='text-light-blue-900 sm:pr-8 mb-6'>
          ...
          <div className='flex gap-4'>
            <a
              href='#'
              target='_blank'
              className='text-light-blue-900 hover:text-light-blue-600 active:text-gray-600 transition duration-100'
            >
              <svg
                className='w-5 h-5'
                width='24'
        ...
        <div>
          <div className='text-blue-900 font-bold tracking-widest uppercase mb-4'>
            Products
          </div>
          ...
          <nav className='flex flex-col gap-4'>
            <div>
              <a
                href='#'
                className='text-light-blue-900 hover:text-light-blue-600 active:text-light-blue-800 transition duration-100'
              >
                Overview
              </a>
            </div>
            ...
            <div>
              <a
                href='#'
                className='text-light-blue-900 hover:text-light-blue-600 active:text-light-blue-600-focus transition duration-100'
              >
                Solutions
              </a>
            </div>
      ...
      <div className='text-light-blue-900 text-sm text-center border-t py-8'>
        © 2021 - Mednow. All rights reserved.
      </div>
    </footer>
  );
}
