      ...
      <Layout>
        <StaticWrapper>
          <motion.div
            ...
            className='max-w-screen-2xl min-w-full mb-24 px-4 md:px-8 mx-auto'
          >
            ...
            >
              <div className='flex flex-col gap-4 p-4 md:p-8'>
                ...
                >
                  <button className='min-w-full block bg-primary hover:bg-primary-focus active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3'>
                    Log in
                  </button>
                </motion.div>
                ...
                >
                  ...
                  <span className='bg-white text-blue-gray-300 text-sm relative px-4'>
                    Log in with social
                  </span>
                </motion.div>
                ...
                >
                  <button className='min-w-full flex justify-center items-center bg-light-blue-900 hover:bg-light-blue-700 active:bg-blue-700 focus-visible:ring ring-teal-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 gap-2 px-8 py-3'>
                    <svg
                ...
                >
                  {' '}
                  <button className='min-w-full flex justify-center items-center bg-white hover:bg-gray-100 active:bg-gray-200 border border-gray-300 focus-visible:ring ring-gray-300 text-gray-800 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 gap-2 px-8 py-3'>
                    <svg
                      className='w-5 h-5 flex-shrink-0'
                      width='24'
                      height='24'
              ...
              >
                <p className='text-blue-gray-300 text-sm text-center'>
                  ...
                  <Link href='/account/register'>
                    <a className='text-light-blue-900 hover:text-teal-600 active:text-teal-700 transition duration-100'>
                      Register
                    </a>
                  </Link>
                </p>
